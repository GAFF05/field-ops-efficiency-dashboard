...
**Estado (2026-08-14): schedule pausado, refresco manual mientras
tanto.** El bloque `schedule:` del workflow está comentado (queda solo
`workflow_dispatch`, corrible a mano desde la pestaña Actions) y **la
Etapa 2 se corre a mano** (ver más abajo) igual que antes de la Fase 6.
Para reactivar el cron: descomentar el bloque `schedule:` en
`.github/workflows/refrescar-dataset.yml`.
